...
$title = "User Management";
  include('label.php');
		...
		"Entry" => 'Office Staff,Packers,Bidi Roller,EPF Challan Date,Resignation',
		"Report" => 'Salary Sheet,Form,ECR Report,ESIC Report,PMRPY Report,PF Challan Yearly,EPF Challan,PF Summary,Payment Advice,Bonus Sheet,Gratuity Calculation,Professional Tax',
