                             ...
                             <div id="datetimepicker1" class="date">
                                 ...
                                 <label id="d" style="color:red;"></label>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                             <div class="form-group">
                                                <label class="control-label"><?= $hra; ?> 1</label>
                                          ...
                                          <div class="col-md-4">
                                             <div class="form-group">
                                                ...
                                                <input type="text" name="hra_bonus1" id="hra_bonus1" class="form-control" placeholder="Enter <?= $hra; ?>" required>	
											            </div>
                                        </div>
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="rate2" id="rate2" class="form-control" placeholder="Enter <?= $rate; ?>2" required>
										         ...
										         <div class="col-md-4">
                                           <div class="form-group">
                                              <label class="control-label"><?= $hra; ?> 2</label>
                                   ...
                                   <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="hra_bonus2" id="hra_bonus2" class="form-control" placeholder="Enter <?= $hra; ?>" required>	
											  </div>
                                        </div>
